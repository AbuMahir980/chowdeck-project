    ...
    <div>
      <div className="px-16  ">
            ...
            <div className="flex justify-around rtl border-black outline-none border-solid">
              <div className="border-black border-4">
                ...
                <div>
                  ...
                  <p className="mx-28 text-green-950 font-semibold mb-52 tracking-[0.2em]">
                    CEO / CO-FOUNDER
                  </p>
                </div>
              </div>

              <span className=" text-[19.5px] mt-14 ml-8 mr-11 text-left ">
                <p className=" mb-2">
        ...
        <div className="border-black border-4 h-44 rounded-b-lg">
          <p className="font-bold mt-8 text-center">BACKED BY</p>
          <span className="flex grayscale mt-7 justify-center">
