...
const HeroCards = ({ image, morelink, heading, content }) => {
  return (
    <div className="rounded-xl border-[3px] border-black w-[32rem]">
      <div className="border-b-[6px] border-black">
        <img src={image} className="w-full rounded-t-lg" />
      </div>
      <div className="p-2 flex flex-col items-center bg-white rounded-b-lg">
