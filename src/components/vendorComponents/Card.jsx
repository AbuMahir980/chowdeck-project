const Card = ({icon, heading, text, actionTxt, actionIcon, contImg}) => {
    return(
        <div>
            <div className="flex flex-col w-[288px] h-[429px] bg-white border border-black border-4 rounded-xl mb-4 pt-5 overflow-hidden">
                <div className="flex flex-col mx-auto px-6 mb-4 gap-4">
